...
$query_1=mysqli_query($link, "INSERT INTO freelancer_inquiries SET UserID='$newUserID', FirstName='$newFirstName', LastName='$newLastName', Email='$newEmail', City='$newLocation', ContactNumber='$newNumber', ContactPrefrence=('" . $newContactPrefrence . "'), Comment='$newComment', PostDate=now() ");
