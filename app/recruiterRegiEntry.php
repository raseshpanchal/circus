...
else
{
    ...
    $query_2=mysqli_query($link, "INSERT INTO recruiter_registration SET FirstName='$newFirstName', LastName='$newLastName', Mobile='$callingNumbar', EmailID='$newEmail', DOB='$newDOB', Gender='$newGender', Password='$newPass', CreateDate=now(), CreateTime=now(), PaidPhoto='No', PaidBanners='No', PaidListing='No', Status='Valid'");
    if($query_2)
    {
        if($newEmail!='')
        {
