...
INSERT INTO `freelancer_registration` (`ID`, `FirstName`, `LastName`, `Mobile`, `EmailID`, `BusinessTitle`, `Professional`, `Address`, `DOB`, `Gender`, `Description`, `CityID`, `StateID`, `CountryID`, `ZipCode`, `Password`, `CreateDate`, `CreateTime`, `PaidPhoto`, `PaidBanners`, `PaidListing`, `Status`) VALUES
(1, 'Rajesh', 'Panchal', '9820937938', 'rajeshp22@gmail.com', '', '', '', '22/08/1980', 'Male', '', 0, 0, 0, '', '%S8C#n%aIn', '2019-06-29', '16:20:30', 'No', 'No', 'No', 'New');
