...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/removeIndustryTitlePictureEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Remove Industry Title Picture</td>
  </tr>
</table>
</div>
...
<div class="row" style="padding:15px; padding-bottom:10px;">
    <div class="col-xs-12" style="text-align:center">
        <div style="width:80px; height:80px; border:solid 1px #CCC; margin-left:225px; margin-bottom:10px; border-radius:50px; background-image:url(../industry-images/<?php echo $newPicture ?>); background-size: 100% 100%;"></div>
        <?php echo $newTitle; ?>
    </div>
</div>
