	...
	$("#btnSave").click(function(){
		...
		function(data){
            if(data==1)
			{
				...
				html += '<td>'+myTitle+'</td>';
				html += '<td align="center"><img src="images/profile-pic.png" /></td>';
				html += '<td align="center"><img src="images/profile-remove-pic.png" /></td>';
			...
			{
				alert('This news title is already added');
				$('#btnSave').attr("disabled", false);
			}
            else if(data==2)
            {
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require summernote" id="txt_desc" name="txt_desc" placeholder="Details*" style="resize: none; height:250px;" required></textarea>
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validNews()">Save</button>
    </div>
</div>
