...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/deleteApplicationsPageEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Delete Applications Page</td>
  </tr>
</table>
</div>
...
<div class="row" style="padding:15px; padding-bottom:10px;">
    <div class="col-xs-12" style="text-align:center">
        <input type="text" class="form-control form-require" id="txt_title" name="txt_title" value="<?php echo $myTitle ?>" readonly />
    </div>
</div>

<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require summernote" id="txt_desc" name="txt_desc" placeholder="Details*" style="resize: none; height:250px;" disabled="disabled"><?php echo $myApplication ?></textarea>
    </div>
</div>

<div class="row" style="padding:15px; padding-top:10px; padding-bottom:10px;">
    <div class="col-xs-6">
        <label><input type="checkbox" <?php if($myPublish=='Yes') echo 'checked="checked"' ?> disabled="disabled"> Publish Online</label>
    </div>
