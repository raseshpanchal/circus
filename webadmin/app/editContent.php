...
$query=mysql_query("SELECT * FROM web_content WHERE ID='$newID'");
$view=mysql_fetch_array($query);
$newTitle=urldecode($view['Title']);
$newShortDesc=urldecode($view['Content']);
...
<script src="app/js/validContent.js"></script>
...
<div class="row" style="padding:15px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" id="txt_title" name="txt_title" value="<?php echo $newTitle ?>" required placeholder="Title*" />
    </div>
</div>

<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require summernote" id="txt_desc" name="txt_desc" placeholder="Details*" style="resize: none; height:250px;" required><?php echo $newShortDesc ?></textarea>
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validContent()">Update</button>
    </div>
</div>
