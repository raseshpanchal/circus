...
$(document).ready(function(){
	...
	$("#btnSave").click(function(){
		...
		function(data){
			...
			{
				alert('This application is already added');
				$('#btnSave').attr("disabled", false);
			}
            else if(data==2)
            {
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validAppIntro()">Save</button>
    </div>
</div>
