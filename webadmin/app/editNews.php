...
$newTitle=$view['Title'];
$newShortDesc=urldecode($view['News']);
...
<script src="app/js/validNews.js"></script>
...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/editNewsEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validNews()">Update</button>
    </div>
</div>
