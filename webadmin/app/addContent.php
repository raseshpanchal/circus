...
$(document).ready(function(){
	...
	$("#btnSave").click(function(){
		...
		function(data){
			...
			{
				alert('This service is already added testimonial');
				$('#btnSave').attr("disabled", false);
			}
            else if(data==2)
            {
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require summernote" id="contents" name="contents" placeholder="Details*"></textarea>

<!--        <textarea class="form-control form-require textarea" id="txt_desc" name="txt_desc" placeholder="Details*" style="resize: none; height:250px;" required></textarea>-->
    </div>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validContent()">Save</button>
    </div>
</div>
