...
<form name="myFormImage" id="myFormImage" method="POST" enctype="multipart/form-data" action="app/addWebImageEntry">
...
<div class="row" style="padding:15px; padding-top:0px; padding-bottom:30px;">
    <div class="col-xs-12">
        ...
        <input type="submit" name="submit" class="btn btn-danger" value="Add" style="padding:6px; width:100px;" onclick="webImages()">
    </div>
</div>
</form>