...
$newMainCatTitle=ucfirst($view_1['MainCat']);
?>
<style>
.success_alert{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Sequence Category under <?php echo $newMainCatTitle; ?></td>
  </tr>
</table>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12" style="height:400px; overflow-y:auto;">
        <ul id="sortable-list">
        <?php
        $query_2=mysqli_query($link, "SELECT * FROM categories WHERE MainCatID='$newID' ORDER BY MyID ASC");
        while($view_2=mysqli_fetch_array($query_2))
        {
            $newMainCatID=$view_2['ID'];
            $newMyID=$view_2['MyID'];
            $newMainCatTitle=$view_2['Category'];
            ?>

            <li title="<?php echo $newMainCatID; ?>"><?php echo '&nbsp;&nbsp;'.$newMyID.'.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$newMainCatTitle; ?><input name="txt_ID" type="hidden" id="txt_ID" value="<?php echo $newMainCatID; ?>"/></li>
            <?php
        }
        ?>
        </ul>
