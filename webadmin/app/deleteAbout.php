...
$query=mysql_query("SELECT * FROM about WHERE ID='$newID'");
$view=mysql_fetch_array($query);
$myTitle=$view['Title'];
$myAbout=urldecode($view['About']);
...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/deleteAboutEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require" id="txt_desc" name="txt_desc" style="resize: none; height:250px;" disabled="disabled"><?php echo $myAbout ?></textarea>
    </div>
</div>
