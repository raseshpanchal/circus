...
$query=mysql_query("SELECT * FROM industry_images WHERE ID='$newID'");
$view=mysql_fetch_array($query);
$myTitle=$view['ImageTitle'];
...
<div class="row" style="padding:15px; padding-top:20px; padding-bottom:15px;">
    <div class="col-xs-12">
        <input type="text" class="form-control form-require" style="text-align:center" value="<?php echo $myTitle ?>" readonly />
    </div>
</div>
