...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Add Industry Title Picture</td>
  </tr>
</table>
</div>
<form name="myFormImage" id="myFormImage" method="POST" enctype="multipart/form-data" action="app/addIndustryTitlePictureEntry?ID=<?php echo $newID ?>">
...
<div class="row" style="padding:15px; padding-top:0px; padding-bottom:30px;">
    <div class="col-xs-12">
        ...
        <input type="submit" name="submit" class="btn btn-danger" value="Add" style="padding:6px; width:100px;" onclick="industryTitleImage()">
    </div>
</div>
</form>