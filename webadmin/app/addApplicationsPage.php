...
<script src="app/js/validApplication.js"></script>
...
$(document).ready(function(){
	...
	$("#btnSave").click(function(){
		...
		$.post("app/addApplicationsPageEntry",
		$("#myForm").serialize(),
		function(data){
            if(data==1)
			{
			...
			{
				alert('This title is already added');
				$('#btnSave').attr("disabled", false);
			}
            else if(data==2)
            {
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>Add New Applications Page</td>
  </tr>
</table>
</div>
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        ...
        <button type="submit" class="btn btn-danger" style="padding:6px; width:100px;" id="btnSave" onMouseDown="validApplication()">Save</button>
    </div>
</div>
