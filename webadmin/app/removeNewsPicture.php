...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/removeNewsPictureEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<div class="row" style="padding:15px; padding-bottom:10px;">
    <div class="col-xs-12" style="text-align:center">
        <div style="width:80px; height:80px; border:solid 1px #CCC; margin-left:225px; margin-bottom:10px; border-radius:50px; background-image:url(../news-images/<?php echo $newPicture ?>); background-size: 100% 100%;"></div>
        <?php echo $newTitle; ?>
    </div>
</div>
