...
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		$.post("app/deleteProductEntry?ID=<?php echo $newID ?>",
		$("#myForm").serialize(),
		function(data){
...
<div class="row" style="padding:15px">
    <div class="col-xs-12">
        <textarea class="form-control form-require summernote" id="txt_desc" name="txt_desc" placeholder="Details*" style="resize: none; height:250px;" disabled="disabled"><?php echo $myProduct ?></textarea>
    </div>
</div>
