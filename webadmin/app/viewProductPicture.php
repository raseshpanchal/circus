...
<div class="row" style="padding:15px; padding-bottom:10px;">
    <div class="col-xs-12" style="text-align:center">
        <div style="width:300px; height:300px; border:solid 1px #CCC; margin-left:125px; margin-bottom:10px; background-image:url(../product-images/<?php echo $myPicture ?>); background-size: 100% 100%;"></div>
        <?php echo $myTitle ?>
    </div>
</div>
