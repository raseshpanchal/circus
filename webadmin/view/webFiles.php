...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM web_files ORDER BY ID DESC");
             ...
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
				...
				<?php echo $newTitle; ?></td>
                 <td id="3_<?php echo $newID ?>">
                    http://www.ambiz.in/web-files/<?php echo $newFileName; ?>
                </td>
                <td width="40" align="center">
                    <a href="http://www.ambizgroup.in/beta/web-files/<?php echo $newFileName; ?>" target="_blank">
                        <img src="images/doc.png" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteWebFile?ID=<?php echo $newID; ?>" class="btnDelete">
