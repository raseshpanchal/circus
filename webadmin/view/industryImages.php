...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM industry_images ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newIndustryID=$view_1['IndustryID'];
				$newPicture=$view_1['Picture'];
				$newImageTitle=$view_1['ImageTitle'];
                //Find Industry Title
                $query_2=mysql_query("SELECT * FROM industries WHERE ID='$newIndustryID'");
                $view_2=mysql_fetch_array($query_2);
                $newTitle=$view_2['Title'];
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
				...
				<?php echo $newImageTitle; ?></td>
                <td width="40" align="center">
                	<a href="app/viewIndustryPicture?ID=<?php echo $newID; ?>" class="btnView"><img src="images/eye.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteIndustryPicture?ID=<?php echo $newID; ?>" class="btnDelete">
...
$(document).ready(function(){
	...
	$("#btnAdd").click(function(){
		addForm('app/addIndustryPicture');
	...
	$("#btnRefresh").click(function(){
		...
		closeForm();
		$("#middleArea").load("view/industryImages");
	});
