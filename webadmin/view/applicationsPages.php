...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM applications_pages ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newTitle=$view_1['Title'];
				$newApplication=urldecode($view_1['Application']);
			...
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                ...
                <td id="3_<?php echo $newID ?>"><?php echo $newApplication; ?></td>
                <td width="40" align="center">
                    <a href="app/editApplicationsPage?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteApplicationsPage?ID=<?php echo $newID; ?>" class="btnDelete">
...
$(document).ready(function(){
	...
	$("#btnAdd").click(function(){
		addForm('app/addApplicationsPage');
	...
	$("#btnRefresh").click(function(){
		...
		closeForm();
		$("#middleArea").load("view/applicationsPages");
	});
