...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM about ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newTitle=$view_1['Title'];
				$newAbout=urldecode($view_1['About']);
			...
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
				...
				<?php echo $newAbout; ?></td>
                <td width="40" align="center">
                    <a href="app/editAbout?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteAbout?ID=<?php echo $newID; ?>" class="btnDelete">
