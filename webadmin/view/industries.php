...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM industries ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newTitle=$view_1['Title'];
				$newInfo=urldecode($view_1['Info']);
			...
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                ...
                <td width="40" align="center">
                	<a href="app/addIndustryTitlePicture?ID=<?php echo $newID; ?>" class="btnPic"><img src="images/profile-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/removeIndustryTitlePicture?ID=<?php echo $newID; ?>" class="btnRemovePic"><img src="images/profile-remove-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/viewIndustryTitlePicture?ID=<?php echo $newID; ?>" class="btnView"><img src="images/eye.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                    <a href="app/editIndustry?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteIndustry?ID=<?php echo $newID; ?>" class="btnDelete">
...
$(document).ready(function(){
	...
	$("#btnRefresh").click(function(){
		...
		closeForm();
		$("#middleArea").load("view/industries");
	});
