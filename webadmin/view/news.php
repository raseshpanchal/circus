    ...
    <table class="table table-striped table-bordered table-hover">
        <thead>
            <tr style="background-color:#d9592d; color:#FFF; border-top:solid 1px #d9592d">
                ...
                <th>News Title</th>
                <th width="40" style="text-align:center">Add</th>
                <th width="40" style="text-align:center">Rem</th>
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM news ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newTitle=$view_1['Title'];
				$newPicture=$view_1['Picture'];
				$newPublish=$view_1['Publish'];
				if($newPublish=='Yes')
				{
					$newPublish='<img src="images/mark-yes.png" border="0" />';
				}
				else
				{
					$newPublish='<img src="images/reject.png" border="0" />';
				}
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                <td id="1_<?php echo $newID ?>" width="40" align="center"><?php echo $i; ?></td>
                <td id="2_<?php echo $newID ?>"><?php echo $newTitle; ?></td>
                <td width="40" align="center">
                	<a href="app/addNewsPicture?ID=<?php echo $newID; ?>" class="btnPic"><img src="images/profile-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/removeNewsPicture?ID=<?php echo $newID; ?>" class="btnRemovePic"><img src="images/profile-remove-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/viewNews?ID=<?php echo $newID; ?>" class="btnView"><img src="images/eye.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/editNews?ID=<?php echo $newID; ?>" class="btnEdit"><img src="images/edit.gif" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/deleteNews?ID=<?php echo $newID; ?>" class="btnDelete"><img src="images/delete.gif" border="0" /></a>
                </td>
            </tr>
            <?php
				$i++;
...
function dataExport()
{
	window.open("exportTestimonials", "myWindow", "scrollbars=no, toolbar=no, menubar=no, status=no, width=550, height=325, resizable=0");
}
...
$(document).ready(function(){
    ...
    //This is Remove Picture function
