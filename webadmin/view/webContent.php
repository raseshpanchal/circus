...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM web_content ORDER BY ID DESC");
			...
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
				...
				if($newPublish=='Yes')
				{
					echo '<img src="images/mark-yes.png" border="0" />&nbsp;&nbsp;';
				}
				else
				{
					echo '<img src="images/indicator-red.png" border="0" />&nbsp;&nbsp;';
				}
				?>
				<?php echo $newTitle; ?></td>
                <td width="40" align="center">
                    <a href="app/editContent?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteContent?ID=<?php echo $newID; ?>" class="btnDelete">
...
$(document).ready(function(){
	...
	$("#btnRefresh").click(function(){
		...
		closeForm();
		$("#middleArea").load("view/webContent");
	});
