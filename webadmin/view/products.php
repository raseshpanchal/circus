...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody style="color:#666" id="table">
            <?php
			$i=1;
			$query_1=mysql_query("SELECT * FROM products ORDER BY ID DESC");
			while($view_1=mysql_fetch_array($query_1))
			{
				$newID=$view_1['ID'];
				$newTitle=$view_1['Title'];
				$newProduct=urldecode($view_1['Product']);
				$newPublish=$view_1['Publish'];
			?>
             <tr <?php echo 'id="td'.$newID.'"'; ?>>
                <td id="1_<?php echo $newID ?>" width="40" align="center"><?php echo $i; ?></td>
                <td id="2_<?php echo $newID ?>" width="200"><?php echo $newTitle; ?></td>
                <td id="3_<?php echo $newID ?>">
				<?php echo $newProduct; ?></td>
                <td width="40" align="center">
                	<a href="app/addProductPicture?ID=<?php echo $newID; ?>" class="btnPic"><img src="images/profile-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/removeProductPicture?ID=<?php echo $newID; ?>" class="btnRemovePic"><img src="images/profile-remove-pic.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                	<a href="app/viewProductPicture?ID=<?php echo $newID; ?>" class="btnView"><img src="images/eye.png" border="0" /></a>
                </td>
                <td width="40" align="center">
                    <a href="app/editProduct?ID=<?php echo $newID; ?>" class="btnEdit">
                        <img src="images/edit.gif" border="0" />
                    </a>
                </td>
                <td width="40" align="center">
                    <a href="app/deleteProduct?ID=<?php echo $newID; ?>" class="btnDelete">
...
function dataExport()
{
	window.open("exportChapters", "myWindow", "scrollbars=no, toolbar=no, menubar=no, status=no, width=550, height=325, resizable=0");
}
