...
#upload-file-container {
   ...
   overflow: hidden;
   margin:25px auto;
   background-image:url(images/uploadPDF.png);
...
<form name="myFormPdf" id="myFormPdf" method="POST" enctype="multipart/form-data" action="app/pdfAddFormEntry">
    <div class="row" style="margin-bottom:15px">
        <div class="col-lg-12">
            <input type="text" class="form-control" id="txt_pdfTitle" name="txt_pdfTitle" placeholder="Enter Title*">
        </div>
    </div>
    <div class="row" style="margin-bottom:15px">
        <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">
            <button type="submit" class="btn btn-default" onclick="profilePDF()" style="float:right; background-color:#FFF">
